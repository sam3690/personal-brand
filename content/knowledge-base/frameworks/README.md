# External Proven Frameworks — Swipe File

> Market-researched frameworks from Hormozi and other proven operators (2026), kept separate
> from `../playbooks/` because these are the raw external methods; the playbooks are Usama's
> own applied version. Read a framework here, see it deployed in the linked playbook.

## What's here

1. **`hormozi-closer-sales-script.md`** — the 6-step sales call structure (4,000+ closes, 116 reps trained). Feeds `../playbooks/objection-handling.md` and the discovery call in `../../business/outreach-scripts.md`.
...
## Rule
These are references, not scripture. Use what fits the actual offer and ICP already validated in `revenue-roadmap.md`; discard what doesn't. A framework earns a place here only if it changes what Usama actually does.
